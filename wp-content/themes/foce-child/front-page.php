...
<main id="primary" class="site-main">
    ...
    <h2 class="titleFadeInUp fadeInUp"><p class="fadeOne">L'</p> <p class="fadeTwo">histoire</p></h2>
        ...
        <article id="place" class="place_article fadeInUp stay animation-background">
            <div>
                <h3 class="titleFadeInUp"><p class="fadeOne">Le</p> <p class="fadeTwo">Lieu</p> </h3>
    ...
    <section id="studio" class="">
        <h2 class="titleFadeInUp fadeInUp"><p class="fadeOne">Studio</p> <p class="fadeTwo">Koukaki</p></h2>
        <div>
